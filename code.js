...
function osubmit(){
    aname=document.getElementById("name").value; uname=document.getElementById("Username").value; pass=document.getElementById("pass").value; 
    email=document.getElementById("email").value; address=document.getElementById("address").value; 
    interests=document.getElementById("interests").value; gender=document.getElementById("gender").value;
   
    document.getElementById("outName").innerHTML="Name: "+aname; document.getElementById("outUsername").innerHTML="Userame: "+uname; document.getElementById("outPass").innerHTML="Password: "+pass; 
    document.getElementById("outEmail").innerHTML="Email: "+email; document.getElementById("outAddress").innerHTML="Address: "+address;  
    document.getElementById("outInterests").innerHTML="Interest/s: "+interests; document.getElementById("outGender").innerHTML="Gender: "+gender;
}
